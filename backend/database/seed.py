...
def seed_users():
    ...
    users = [
        ...
        User(user_fname="Michael", user_lname="Brown", user_email="michaelbrown@port.ac.uk",
             user_displayname="MikeBrown88", user_use_displayname=True, dark_mode=True),
        User(user_fname="Sarah", user_lname="Wilson", user_email="sarahwilson@port.ac.uk", dark_mode=False),
        ...
        User(user_fname="David", user_lname="Taylor", user_email="davidtaylor@port.ac.uk", user_displayname="Taylor_D",
             user_use_displayname=True, dark_mode=True),
        User(user_fname="Lisa", user_lname="Anderson", user_email="lisaanderson@port.ac.uk", dark_mode=False),
        User(user_fname="Test", user_lname="Test", user_email="test@test.app", user_token="fbde5c7f68cdd28e9105cdbafa6556eb", dark_mode=False)
